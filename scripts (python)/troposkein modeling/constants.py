...
# create methode renderingTypeToString(renderingType)
def renderingTypeToString(renderingType):
    if renderingType == PERSISTENCE_TYPE:
        return "PERSISTENCE_TYPE"
    elif renderingType == ARRAY_TYPE:
        return "ARRAY_TYPE"
    elif renderingType == PROJECTION_TYPE:
...
MIN_VERTICAL_RESOLUTION = 29 # 220
...
# strip height
MIN_POLE_HEIGHT = 200
MAX_POLE_HEIGHT = MIN_POLE_HEIGHT + 42 * DEFAULT_PIXEL_PITCH
