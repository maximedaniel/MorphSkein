#ifndef My_Adafruit_SPIDevice_h
#define My_Adafruit_SPIDevice_h
...
class My_Adafruit_SPIDevice {
public:
#ifdef BUSIO_HAS_HW_SPI
  My_Adafruit_SPIDevice(int8_t cspin, uint32_t freq = 1000000,
...
#endif
  My_Adafruit_SPIDevice(int8_t cspin, int8_t sck, int8_t miso, int8_t mosi,
                     uint32_t freq = 1000000,
                     BusIOBitOrder dataOrder = SPI_BITORDER_MSBFIRST,
                     uint8_t dataMode = SPI_MODE0);
  ~My_Adafruit_SPIDevice();
